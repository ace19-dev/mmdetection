...
CLASSES = ('small ship', 'large ship', 'civilian aircraft', 'military aircraft', 'small car', 'bus', 'truck',
           'train', 'crane', 'bridge', 'oil tank', 'dam', 'athletic field', 'helipad', 'roundabout')
...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=(1024, 1024), ratio_range=(1.3, 1.3), keep_ratio=True),
    dict(type='RandomCrop', crop_size=(640, 640)),
    dict(type='RandomFlip', flip_ratio=0.5),
    # dict(type='Rotate', level=5, prob=0.7, max_rotate_angle=45),
